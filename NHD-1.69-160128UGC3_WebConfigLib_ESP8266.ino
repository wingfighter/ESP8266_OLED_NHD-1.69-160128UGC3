    ...
    while(1)                                          // wait here forever
    {
        ...
        for ( int i=0; i<4;i++) // 10, wenn alle 9 Zusatzdisplay ausgewertet werden sollen
        {
          if (strcmp(espClient.MyOLEDDisplay[i].Screen, "clear") !=0)
          {
            ...
            OLED_FillArea_160128RGB(0, 159, 100, 127, BLACK);
            // Display Toptitle
            OLED_String2x_160128RGB(0, 100, topDisplay , BLUE, BLACK);    
            switch (i) 
            {
               case 0:
            ...
            OLED_String2x_160128RGB(80 - sizeof(topDisplay)/sizeof(topDisplay[0]) * 4, 100, topDisplay , BLUE, BLACK);   // Toptitle
            OLED_StringVerdana_160128RGB(3, 80, charDisplay, YELLOW, BLACK);   // Value
            if (strcmp(webUnit, "*C") == 0) {
                OLED_Text_160128RGB(102, 80, 11, YELLOW, BLACK);   // ° - Abstand 28 (Zeichenbreite) + 8
                OLED_Text_160128RGB(126, 80, 10, YELLOW, BLACK);   // C - Abstand 28 (Zeichenbreite) + 8
            } else {
                OLED_Text_160128RGB(102, 80, 12, YELLOW, BLACK);   // % left - Abstand 28 (Zeichenbreite) + 8
